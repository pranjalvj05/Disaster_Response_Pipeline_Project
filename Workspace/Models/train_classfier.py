...
def load_data(database_filepath, table_name='Table_Clean'):
    """Loading the cleaned data from database into the dataframe.
    Args:
        database_filepath: String. It has cleaned data table.
        table_name: String. It has cleaned data.
    Returns:
       X: numpy.ndarray. Disaster messages.
       Y: numpy.ndarray. Disaster categories for  message.
       category_name: list. names of Disaster category .
    """
    # loading the data 
...
def save_stats(X, Y, category_names, vocabulary_stats_filepath, category_stats_filepath):
    """Save stats
    Args;
        vocaburary_stats_filepath: String.saved as pickel.
        category_stats_filepath: String.  saved as pickel.
    """
    # Checking and Converting vocabulary into pandas.dataframe
...
def evaluate_model(model, X_test, Y_test, category_names):
    """ model evalution
    Args:
        model: sklearn.model_selection.GridSearchCV.  It has a sklearn estimator.
    """
    # Predicting the categories of messages.
    Y_pred = model.predict(X_test)

    #Now print accuracy, precision, recall and f1_score for each categories
